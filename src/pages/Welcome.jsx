...
const {scrollY} = useScroll() // get number of pixels user scrolled

//do not impact performance
const yCity = useTransform(scrollY, [0, 200], [0, -100])
const opacityCity = useTransform(scrollY, [0, 200, 300, 500], [1, 0.5, 0.5, 0]) //[scrollY values], [opacity values]
const yHero = useTransform(scrollY, [0, 200], [0, -150])
const opacityHero = useTransform(scrollY, [0, 300, 500], [1, 1, 0]) //[scrollY values], [opacity values]
